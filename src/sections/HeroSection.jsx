...
const HeroSection = () => {
    return (
        <section className="flex flex-col items-center justify-center min-h-screen bg-black text-white py-16">
            <div className="flex flex-row items-center justify-center m-10">
                ...
                <div className="text-center sm:text-left">
                    <h1 className="text-6xl font-bold text-[#f48e6c]">BrunoPay</h1>
                    <p className="text-xl mt-2 text-[#5fcbbc]">For Coders, By Coders</p>
                </div>
            </div>
                ...
                <div className="flex flex-col items-center sm:flex-row sm:justify-center relative">
                    ...
                    <div className="relative sm:mt-0 -z-1 sm:-mr-12 -mt-15">
                        ...
                        <img
                            ...
                            alt="Left Card"
                            className="w-64 sm:w-80 opacity-80 relative"
                        />
                    </div>
                    ...
                    <div className="relative sm:scale-110 z-10">
                        ...
                        <img
                            ...
                            alt="Main Card"
                            className="w-80 sm:w-96 relative"
                        />
                    </div>
